...
class FileHandlerBackend(HandlerBackend):
    ...
    delay: Incomplete
    timer: Incomplete
    def __init__(self, handlers=None, filename: str = './.handler-saves/handlers.save', delay: int = 120) -> None: ...
    def register_handler(self, handler_group_id, handler) -> None: ...
    def clear_handlers(self, handler_group_id) -> None: ...
    def get_handlers(self, handler_group_id): ...
    def start_save_timer(self) -> None: ...
    def save_handlers(self) -> None: ...
    def load_handlers(self, filename=None, del_file_after_loading: bool = True) -> None: ...
    @staticmethod
...
class RedisHandlerBackend(HandlerBackend):
    prefix: Incomplete
    redis: Incomplete
    def __init__(self, handlers=None, host: str = 'localhost', port: int = 6379, db: int = 0, prefix: str = 'telebot', password=None) -> None: ...
    def register_handler(self, handler_group_id, handler) -> None: ...
    def clear_handlers(self, handler_group_id) -> None: ...
    def get_handlers(self, handler_group_id): ...
